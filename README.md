...
<p>
To being the installation process you need to turn on Windows features. illustrated above, you turn on the IIS Management Console, CGI, and Common HTTP Features.
</p>
<br />
